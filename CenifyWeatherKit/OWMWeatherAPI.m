...
-(void) searchForCityName:(NSString *)name
         withCallback:( void (^)( NSError* error, NSDictionary *result ) )callback
{
    NSString *method = [NSString stringWithFormat:@"/find?q=%@&units=metric", [name stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLPathAllowedCharacterSet]]];
    [self callMethod:method withCallback:callback];
}
...
-(void) searchForCityName:(NSString *)name
             ...
             andCallback:( void (^)( NSError* error, NSDictionary *result ) )callback
{
    NSString *method = [NSString stringWithFormat:@"/find?q=%@&units=metric&cnt=%d", [name stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLPathAllowedCharacterSet]], count];
    [self callMethod:method withCallback:callback];
}
